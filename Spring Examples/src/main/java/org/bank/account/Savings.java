...
public class Savings implements BankAccountService
{
    ...
    public Savings(BankAccountDetails bankAccountDetails)
    {
     ...
     * @param account_type The types of account we want to create
     * @return The Savings account object
     */
    @Override
    public BankAccountService createAccount(Long account_no,String account_name, AccountType account_type,String password)
    {
        ...
        if(input==1)
        {
            try
            {
                ...
                bankAccountDetails.setAccount_type(AccountType.Savings);
                    ...
                    System.out.println("Deposited amount 1000 rupees in bank account and details of your " +
                            "of your bank account is "+bankAccountDetails.getAccount_no()+"\n"
                                                      +bankAccountDetails.getHolder_name()+"\n"
                                                       +bankAccountDetails.getAccount_type()+"\n");
                }
                else
                {
